drop table  if exists rating, genre_name, films,  genre, users, ls_likes, friend_status, friends;
...
CREATE TABLE IF NOT exists friends (
  ...
  status_id integer NOT NULL REFERENCES friend_status(status_id) ON DELETE cascade
);